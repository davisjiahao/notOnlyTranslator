...
export default function MasteryOverview({ isSaving }: MasteryOverviewProps) {
  ...
  const loadMasteryData = async () => {
    ...
    try {
      // 并行获取所有数据
      const [levelResponse, overviewResponse, reviewResponse, trendResponse] =
        await Promise.all([
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">词汇掌握度概览</h2>
        ...
        <div className="relative pt-2">
          <div className="flex justify-between text-xs text-gray-500 mb-1">
            {CEFR_LEVELS.map((l) => (
              <span
                key={l.level}
                className={`transition-colors ${l.level === cefrLevel ? 'font-bold text-gray-900' : ''}`}
              >
                {l.level}
              </span>
            ))}
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.masteredWords}</div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.learningWords}</div>
            <div className="text-xs text-gray-500">
              {stats.totalWords > 0
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-gray-600">需加强</span>
            </div>
            <div className="text-2xl font-bold text-gray-900">{stats.strugglingWords}</div>
            <div className="text-xs text-gray-500">
              {stats.totalWords > 0
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <div className="text-2xl font-bold text-gray-900">{stats.dueForReview}</div>
            <div className="text-xs text-gray-500">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {/* CEFR 等级分布 */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-base font-semibold text-gray-900 mb-4">CEFR 等级分布</h3>
        ...
        {/* 掌握度分布饼图 */}
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <h3 className="text-base font-semibold text-gray-900 mb-4">掌握度分布</h3>
      ...
      {trendData && trendData.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-base font-semibold text-gray-900">30 天学习趋势</h3>
            {trend?.masteryChangeRate !== undefined && (
              <div className="text-sm">
                <span className="text-gray-500">增长率: </span>
                <span
                  className={`font-medium ${
                    trend.masteryChangeRate >= 0 ? 'text-green-600' : 'text-red-600'
                  }`}
                >
      ...
      {/* 数据导出/重置 */}
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h3 className="text-base font-semibold text-gray-900 mb-4">数据管理</h3>
