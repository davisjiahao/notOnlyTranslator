...
export default function ApiKeyWizard({ onComplete, onSkip }: ApiKeyWizardProps) {
  ...
  const StepIndicator = () => {
    ...
    return (
      <div className="flex items-center justify-center gap-2 mb-8" role="progressbar" aria-valuemin={0} aria-valuemax={steps.length - 1} aria-valuenow={currentIndex} aria-label={`设置进度：${steps[currentIndex]?.label || '欢迎'}`}>
      ...
      <div className="max-w-lg mx-auto">
        <div className="text-center mb-8">
          <div className="w-20 h-20 mx-auto mb-6 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center">
            <svg aria-hidden="true" className="w-10 h-10 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 mb-8">
          <div className="flex items-start gap-3">
            <svg aria-hidden="true" className="w-5 h-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex gap-3">
          {onSkip && (
            <button
              onClick={onSkip}
              className="flex-1 py-3 px-4 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-500 font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2"
            >
              稍后再说
            </button>
          )}
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="flex items-start gap-2 text-sm text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg">
            <svg aria-hidden="true" className="w-5 h-5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-4 mb-8">
          ...
          {useCustomModel ? (
            ...
            <div className="space-y-2" role="radiogroup" aria-label="选择翻译模型">
              {isLoadingModels ? (
                <div className="text-center py-8">
                  <svg aria-hidden="true" className="w-8 h-8 mx-auto animate-spin text-primary-600" fill="none" viewBox="0 0 24 24">
                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                  </svg>
