...
- LLM APIs: OpenAI GPT-4o-mini, Anthropic Codex, or OpenAI-compatible custom endpoints
...
- Anthropic (default: Codex-3-haiku)
...
**注意：** Playwright MCP 已在项目级别配置（见 `~/.Codex.json`），Codex 重启后自动可用。
