...
| ESLint | ✅ 通过 | 0 警告 |
| 单元测试 | ✅ 通过 | **1027/1027** (100.83s) |
| Git 状态 | 🔴 Critical | **378 commits** 未推送 🚨 |

## Git 状态

- **分支**: main
- **最新提交**: `96e623a` - docs(test-results-analyzer): Heartbeat #1 (2026-04-16)
- **严重警告**: 378 commits 领先 origin/main 🚨 **持续恶化！**
...
| 问题 | 详情 |
|------|------|
| Git 同步滞后 | **378 commits** 领先 origin/main 🚨 **持续恶化** |
